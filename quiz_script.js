...
function generate_question(mark_question, question_marked) {
    ...
    question_awnser[0].style.color = 'white'
    question_awnser[1].style.color = 'white'
    question_awnser[2].style.color = 'white'
    question_awnser[3].style.color = 'white'
...
let user_navigate_buttons = document.getElementById('user_navigate_buttons')
user_navigate_buttons.addEventListener('click', () => {
